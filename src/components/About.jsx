...
export default function About() {
  ...
  return (
    <div id="about" className='bg-[#032845] w-screen overflow-hidden flex flex-col h-auto' >
        <div>
      ...
      <div className='flex h-full w-full justify-center items-center align-middle  '>
        <div className='text-2xl text-gray-50 text-center h-auto w-3/5 '>
...
I invite you to explore my website to learn more about my work. Thank you for taking the time to visit my website, and I look forward to hearing from you soon.
      ...
      <div className="flex flex-auto flex-col md:flex-row justify-center items-center m-9 transition-all duration-150 ease-out hover:ease-in">
          {socials.map(({ id, title, src, link }) => (
            <div
              key={id}
              className="bg-blue-800 w-40 h-10 m-2 static rounded-lg"
            >
              <div className="bg-blue-500 text-white font-light w-40 h-10 hover:-m-2 text-center flex items-center absolute rounded-lg shadow-lg hover:shadow-xl transition-all duration-150 ease-out hover:ease-in"
              >
